...
var redux_logger_1 = __webpack_require__(52);
var defaultState = {
    count: 0,
    names: []
};
var rootReducer = function (y, a) {
    if (a.type === "@@redux/INIT")
        return defaultState;
    return { count: y.count + 1, names: a.names };
};
var store = Redux.createStore(rootReducer, defaultState, Redux.applyMiddleware(redux_logger_1.default));
function dispatch(a) {
    store.dispatch(a);
}
...
ReactDOM.render((React.createElement(react_redux_1.Provider, { store: store_1.getStore() },
    React.createElement(App_1.default, null))), document.getElementById('app_root'));
...
var React = __webpack_require__(1);
var react_redux_1 = __webpack_require__(2);
var get_names_1 = __webpack_require__(55);
var Names_1 = __webpack_require__(56);
exports.App = function (props) { return (React.createElement("div", null,
    React.createElement("h1", null,
        "You've generated names ",
        props.count,
        " times!"),
    React.createElement("button", { onClick: get_names_1.generateNames }, "Generate Names!"),
    React.createElement(Names_1.default, null))); };
...
var React = __webpack_require__(1);
var react_redux_1 = __webpack_require__(2);
exports.Names = function (props) { return (React.createElement("div", null, props.names.map(function (n) { return (React.createElement("div", { key: n }, n)); }))); };
var mapStateToProps = function (state) {
    return { names: state.names };
};
exports.default = react_redux_1.connect(mapStateToProps)(exports.Names);
